	...
	jQuery(function() {
		...
		jQuery('#calendar').fullCalendar({
			...
			events: [
				...
				{
					title: '히스토리 보이즈',
					description: '헥터 役 | 오대석<br>어윈 役 | 박정복<br>린톳 役 | 송희정<br>교장 役 | 김수환<br>데이킨 役 | 최정우<br>포스너 役 | 안지환<br>스크립스 役 | 송광일<br>럿지 役 | 김주헌<br>락우드 役 | 차현성<br>악타 役 | 신은호<br>팀스 役 | 민현기<br>크라우더 役 | 김보근',
