...
function showContent(idx, sco){
	...
	const scoreImg = [["https://blog.kakaocdn.net/dn/swOYB/btsK8LwIU0k/9dBhI63vPHM0mcpHgNXqnk/img.png","https://blog.kakaocdn.net/dn/Y9Tig/btsK8jURDhs/G1OPuwbSrsKMDPl2UARsO0/img.png","https://blog.kakaocdn.net/dn/cJ2Kpv/btsK7KFnHEh/RSMX6KTAZ6aT2tV1vcV7CK/img.png"]
						,["https://blog.kakaocdn.net/dn/cihNEZ/btsK9fqzeFP/qBcTZkb6pew5srJDf8EnjK/img.png","https://blog.kakaocdn.net/dn/cTqarV/btsK9C7g1D5/K0EokaFMoARD9zkQGelHsk/img.png","https://blog.kakaocdn.net/dn/EHmMc/btsK9RW47Ta/PnrLI9AkPhYQkESVgrLa0k/img.png"]
						...
						,["https://blog.kakaocdn.net/dn/q541y/btsK9zQhT4m/Vnxl9sUppAGdQkTRSgbi2K/img.png","https://blog.kakaocdn.net/dn/bkAr0C/btsK8q7uF2s/rDjJmrfofrz4bj2si0cvyK/img.png","https://blog.kakaocdn.net/dn/bntSy9/btsK83cKEfo/znp7zHUJbiCV45VW4K30P0/img.png"]
	...
	switch(Number(idx)){
		...
		case 1: //토루
			...
			$('.recommendCont .recCont2 .page-content').append($('<div>',{'class':'card','style':'background-image:url("https://i.ytimg.com/vi_webp/_Ce4VBejt4U/maxresdefault.webp")'}).append($('<div>',{'class':'content'}).append($('<div>',{'class':'title','text':'포토타임'}), $('<div>',{'class':'copy'}).append($('<span>',{'text':''})), $('<button>',{'class':'btn','text':'보러가기','onclick':'window.open("https://youtu.be/_Ce4VBejt4U")'}))));
			break;
		case 2: //최윤
		...
		case 4: //안지환
			...
			$('.recommendCont .recCont2 .page-content').append($('<div>',{'class':'card','style':'background-image:url("https://i.ytimg.com/vi_webp/sS1r6QJqQlo/maxresdefault.webp")'}).append($('<div>',{'class':'content'}).append($('<div>',{'class':'title','text':'바톤콘서트(2)'}), $('<div>',{'class':'copy'}).append($('<span>',{'text':''})), $('<button>',{'class':'btn','text':'보러가기','onclick':'window.open("https://youtu.be/sS1r6QJqQlo")'}))));
			$('.recommendCont .recCont2 .page-content').append($('<div>',{'class':'card','style':'background-image:url("https://i.ytimg.com/vi_webp/P8LTtJCeyKs/maxresdefault.webp")'}).append($('<div>',{'class':'content'}).append($('<div>',{'class':'title','text':'바톤콘서트(3)'}), $('<div>',{'class':'copy'}).append($('<span>',{'text':''})), $('<button>',{'class':'btn','text':'보러가기','onclick':'window.open("https://youtu.be/P8LTtJCeyKs")'}))));
			$('.recommendCont .recCont2 .page-content').append($('<div>',{'class':'card','style':'background-image:url("https://i.ytimg.com/vi_webp/Rvs2ErL4Dl0/maxresdefault.webp")'}).append($('<div>',{'class':'content'}).append($('<div>',{'class':'title','text':'바톤콘서트(4)'}), $('<div>',{'class':'copy'}).append($('<span>',{'text':''})), $('<button>',{'class':'btn','text':'보러가기','onclick':'window.open("https://youtu.be/Rvs2ErL4Dl0")'}))));
			...
			$('.recommendCont .recCont2 .page-content').append($('<div>',{'class':'card','style':'background-image:url("https://i.ytimg.com/vi_webp/tgxmV6LCbTM/maxresdefault.webp")'}).append($('<div>',{'class':'content'}).append($('<div>',{'class':'title','text':'퇴근길(2)'}), $('<div>',{'class':'copy'}).append($('<span>',{'text':''})), $('<button>',{'class':'btn','text':'보러가기','onclick':'window.open("https://youtu.be/tgxmV6LCbTM")'}))));
			$('.recommendCont .recCont2 .page-content').append($('<div>',{'class':'card','style':'background-image:url("https://i.ytimg.com/vi/yIdeZFx9xz8/maxresdefault.jpg")'}).append($('<div>',{'class':'content'}).append($('<div>',{'class':'title','text':'퇴근길(3)'}), $('<div>',{'class':'copy'}).append($('<span>',{'text':''})), $('<button>',{'class':'btn','text':'보러가기','onclick':'window.open("https://youtu.be/yIdeZFx9xz8")'}))));
			break;
		default: break;
	}	
}
