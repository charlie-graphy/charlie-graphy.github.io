...
아니면 못한 걸까요?”`,
			...
			clues: { // 사용자 제공 열쇠
			    across: [
			        { num: 2, clue: "ㅇㅇ은 그림이 아니야.(mirror)" },                     // 거울
			        { num: 4, clue: "로스가 다시 읽고 있는 것. 그리스 ㅇㅇ" },  // 비극
...
내가 결코 닿을 수 없는 곳으로.”`,
			...
			clues: { // 사용자 제공 열쇠
			    across: [
			        ...
			        { num: 2, clue: "마지막 ㅇㅇ은 여기 구내과병원에서" },  // 안녕
			        { num: 6, clue: "동인들이 화를 입은 사건" },    // 기축사화
			        { num: 7, clue: "데이비가 8살 소녀에게 빼앗은 것" }    // 자전거
			    ],
			    down: [
			        { num: 3, clue: "친구가 놀러오면 2개를 내놔야 하는 것" },                       // 소시지
			        { num: 4, clue: "구내과병원에서 지환 배우의 역할명" }, // 장기준
			        { num: 5, clue: "최윤이 사흘만에 치른 시험" }    // 과거
			    ]
			}
        },
        5: { 
